...
- **10.11.x** → `JellyAuth_1.2.1.0_jellyfin-10.11.11.zip`
- **12.x** → `JellyAuth_1.2.1.0_jellyfin-12.1.zip`

Descompacta numa pasta dentro de `plugins/` (tipo `JellyAuth_1.2.1.0/`) e reinicia o Jellyfin.
